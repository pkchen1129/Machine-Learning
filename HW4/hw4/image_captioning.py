...
def main():
    # The dataset can be downloaded in https://drive.google.com/file/d/1kUuoIyImtnfmKcdrQt8t3MVuKMYUXKD8/view?usp=sharing 
    ...
    for split in ['train', 'val']:
        # some images might be deprecated. You may rerun the code to successfully get
        # the sample images from url.
